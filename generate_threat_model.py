...
for resultado in semgrep_data.get("results", []):
    ...
    try:
        if "SQL Injection" in mensagem:
            ...
            ameaca_mass_assignment = Threat(SID=f"MA-{contador_ameacas}")
            ...
            ameaca_improper_validation = Threat(SID=f"IV-{contador_ameacas}")
            ...
            ameaca_code_injection = Threat(SID=f"CI-{contador_ameacas}")
            ...
            ameaca_debug_code = Threat(SID=f"ADC-{contador_ameacas}")
